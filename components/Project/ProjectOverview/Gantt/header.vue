<template>
  <div class="vuecal__header">
    ...
    >
      <template>
        <div v-for="(v, id) in viewProps.views" :key="id">
          <button
            class="vuecal__view-btn"
            v-if="v.enabled"
            type="button"
            :class="{
              'vuecal__view-btn--active': view.id === id,
              'vuecal__view-btn--highlighted': highlightedControl === id,
            }"
            @dragenter="
              editEvents.drag &&
                dnd &&
                dnd.viewSelectorDragEnter($event, id, $data)
            "
            @dragleave="
              editEvents.drag &&
                dnd &&
                dnd.viewSelectorDragLeave($event, id, $data)
            "
    ...
    <div class="vuecal__title-bar" v-if="!options.hideTitleBar">
      <button
        ...
        type="button"
        :class="{
          'vuecal__arrow--highlighted': highlightedControl === 'previous',
        }"
        @click="previous"
        @dragenter="
          editEvents.drag &&
      ...
      <div class="vuecal__flex vuecal__title" grow="grow">
        <transition
          :name="
            options.transitions ? `slide-fade--${transitionDirection}` : ''
          "
        >
          <component
      ...
      <button
        ...
        type="button"
        :class="{
          'vuecal__today-btn--highlighted': highlightedControl === 'today',
        }"
        @click="goToToday"
        @dragenter="
          editEvents.drag &&
