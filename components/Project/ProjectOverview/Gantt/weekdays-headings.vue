<template>
  <div style="display: grid; grid-template-columns: 30% 70%">
    ...
    <div style="padding: 0" class="vuecal__flex vuecal__weekdays-headings">
      <template v-for="(heading, i) in view.id === 'week' ? headings : []">
        <div
          :key="i"
      ...
      <template v-for="(heading, i) in view.id === 'year' ? yearHeadings : []">
        <div
          class="vuecal__flex vuecal__heading"
          :key="i"
          v-if="!heading.hide"
