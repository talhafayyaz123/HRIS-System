...
const { router, Toast, deleteAlert } = commonCode(),
  ...
  emit = defineEmits(["tab4Done", "backToTab3"]),
...
const editEmployee = () => {
  ...
  if (v2$.value.$invalid) {
    ...
    updateEmployeeRequest({
      ...
      types: ["customer"],
      set_company_id: props.customerId,
    })
      .then((response) => {
        ...
        >
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
              <div class="form-group">
                <elements-input
                  v-model="employeeTemp.first_name"
                  :label="$t('First Name')"
                  id="first_name"
                  :disabled="employeeTemp.submitted"
                />
            ...
            <div class="col-lg-6 col-md-6">
              <div class="form-group">
                <elements-input
                  v-model="employeeTemp.last_name"
                  :label="$t('Last Name')"
                  id="last_name"
                  :disabled="employeeTemp.submitted"
                />
            ...
            <div class="col-lg-6 col-md-6">
              <div class="form-group">
                <elements-input
                  v-model="employeeTemp.email"
                  :label="$t('Email')"
                  :required="true"
                  id="email"
                  :disabled="employeeTemp.submitted"
                  :class="{ 'is-invalid': v2$.email.$error }"
                />
            ...
            <div class="col-lg-6 col-md-6">
              <div class="form-group">
                <elements-input
                  v-model="employeeTemp.department"
                  :label="$t('Department')"
                  id="addressLine1"
                  :disabled="employeeTemp.submitted"
                />
            ...
            <div class="col-lg-6 col-md-6">
              <div class="form-group">
                <elements-multiselect
                  v-model="employeeTemp.location_id"
                  :options="locations"
          ...
          <div class="col-lg-6 col-md-6">
            <div class="form-group">
              ...
              <elements-input
                ...
                id="email"
                :disabled="employee.submitted"
                :class="{ 'is-invalid': v$.email.$error && employee.submitted }"
              />
              </div>
              
            </div>
            <div
                v-if="v$.email.$error && employee.submitted"
                class="invalid-feedback"
              >
                <span
                  class="text-danger"
                  v-if="v$.email.required && employee.submitted"
              ...
              <tr v-for="(item, index) in employees" :key="index">
                ...
                <td>
                  <i
                    ...
                    @click.prevent="getEmployee(item?.id)"
                  ></i>
                  <i
                    class="mdi mdi-delete edit-icon"
                    @click.prevent="popEmployee(item?.id)"
                  ></i>
                </td>
              </tr>
            </tbody>
