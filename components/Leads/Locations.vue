...
import {
  leadLocationCreateRequest,
  leadShowRequest,
  leadLocationDeleteRequest,
...
const { router, Toast } = commonCode(),
  ...
  locations = ref([]),
  emit = defineEmits(["locationsDone", "backToDetails", "getLocations"]),
  validationRules = {
        ...
        <div class="table-responsive mt-3">
          <table class="doc-table table">
            ...
            <tbody>
              ...
              <tr v-else v-for="(item, index) in locations" :key="index">
