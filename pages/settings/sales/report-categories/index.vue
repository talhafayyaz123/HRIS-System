...
const {
  ...
  optionalItems = {
    searchBar: true,
    isBtnShow: true,
    btnText: t("Create Report Category"),
    path: "/settings/sales/report-categories/create",
  },
  columnConfig = [
    {
      label: "Name",
  ...
  { title } = useTitle("Report Categories"),
...
<template>
  <div>
    ...
    <Table
      ...
      :columns="columns"
      :rows="data?.data"
      editPath="/settings/sales/report-categories/edit-"
