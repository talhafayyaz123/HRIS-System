...
const breadCrumbsConfig = [
  ...
  { title } = useTitle("Edit Price List"),
...
function refresh() {
  ...
  priceListShowRequest(priceListId)
    .then((response) => {
      layout.changeLoaderValue(false);
      state.name = response.data?.name;
      state.productSoftwareId = response.data?.productSoftwareId;
      state.isDefault = response.data?.isDefault;
