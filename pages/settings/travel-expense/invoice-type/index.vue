...
const {
  ...
  optionalItems = {
    searchBar: true,
    isBtnShow: true,
    btnText: "Create Invoice Type",
    path: "/settings/travel-expense/invoice-type/create",
  },
  columnConfig = [
    {
      label: "Name",
...
apiRoute.value = routes.INVOICE_TYPE;
