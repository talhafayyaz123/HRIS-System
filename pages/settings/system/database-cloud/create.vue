...
import { databaseCloudCreateRequest } from "~/utils/apiRequests";
...
const { router, Toast } = commonCode(),
  ...
  { title } = useTitle("Create Database Clouds"),
  ...
  <div>
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="card-title me-2">{{ $t("Fill Database Cloud Details") }}</h3>
        <elements-tooltip />
      </div>
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="form-group">
              <elements-input
                ...
                id="name"
                :disabled="state.submitted"
                :class="{ 'is-invalid': v$.databaseType.$error }"
              />
            </div>
