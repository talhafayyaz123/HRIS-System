...
import {
  databaseCloudUpdateRequest,
  databaseCloudShowRequest,
...
const { router, Toast } = commonCode(),
  ...
  databaseCloudId = router.params.id,
  state2 = reactive({
    submitted: false,
    serverIp: "",
    port: "",
  ...
  breadCrumbsConfig = [
    ...
    {
      text: "Database Cloud",
      to: "/settings/system/database-cloud",
    },
    {
      text: "Edit",
      active: true,
  ...
  { title } = useTitle("Edit Database Cloud"),
    ...
    try {
      ...
      databaseCloudUpdateRequest(
        ...
        .then((response) => {
          ...
          state.submitted = false;
          navigateTo("/settings/system/database-cloud");
        })
        .catch((error) => {
          layout.changeLoaderValue(false);
          state.isLoading = false;
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t("Fill Database Cloud Details") }}</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <elements-input
                    ...
                    :class="{ 'is-invalid': v$.name.$error }"
                  />
                  <div v-if="v$.databaseType.$error" class="invalid-feedback">
                    <span class="text-danger" v-if="v$.databaseType.required">{{
                      $t("This value is required")
                    }}</span
                    ><br />
                  </div>
    ...
    <div class="">
      ...
      <div class="mt-3 d-flex align-items-center justify-content-end">
        <button
          ...
          @click="navigateTo('/settings/system/database-cloud')"
        >
