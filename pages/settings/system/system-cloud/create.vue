...
import { cloudSystemCreateRequest } from "~/utils/apiRequests";
...
const { router, Toast } = commonCode(),
  ...
  { title } = useTitle("Create Cloud Systems"),
  ...
  <div>
    ...
    <div class="card">
      <div class="card-header d-flex align-items-center">
        <h3 class="card-title me-2">{{ $t("Fill Cloud System Details") }}</h3>
        <elements-tooltip />
      </div>
      <div class="card-body">
        <div class="row">
