...
import {
  cloudSystemUpdateRequest,
  cloudSystemShowRequest,
...
const { router, Toast } = commonCode(),
  ...
  cloudSystemId = router.params.id,
  state2 = reactive({
    submitted: false,
    serverIp: "",
    port: "",
  ...
  breadCrumbsConfig = [
    ...
    {
      text: "Cloud Systems",
      to: "/settings/system/system-cloud",
    },
    {
      text: "Edit",
      active: true,
  ...
  { title } = useTitle("Edit Cloud Systems"),
...
function refresh() {
  ...
  cloudSystemShowRequest(cloudSystemId)
    .then((response) => {
    ...
    try {
      ...
      cloudSystemUpdateRequest(
        ...
        .then((response) => {
          ...
          state.submitted = false;
          navigateTo("/settings/system/system-cloud");
        })
        .catch((error) => {
          layout.changeLoaderValue(false);
          state.isLoading = false;
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t("Fill Cloud System Details") }}</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-lg-4">
    ...
    <div class="">
      ...
      <div class="mt-3 d-flex align-items-center justify-content-end">
        <button
          ...
          @click="navigateTo('/settings/system/system-cloud')"
        >
