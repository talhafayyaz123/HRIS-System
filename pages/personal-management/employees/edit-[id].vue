...
const { router, Toast } = commonCode(),
  ...
  userProfileId = router.params.id,
  step = ref(1);
...
const createProfilePicture = () => {
  ...
  formData.append("employeeId", userProfileId);
...
const { items } = useTranslatedBreadCrumbs(breadCrumbsConfig),
    { title } = useTitle("Edit User Profile");
...
<template>
  <div>
    ...
    <div class="row mt-4 mb-4 employee-profile">
      <div class="col-lg-3">
    ...
    <div class="wizard-content">
      ...
      <div class="" v-show="step === 1">
        <user-profile
          ...
          @userProfileDone="step = 2"
          :isUpdate="isUpdateUserProfile"
      ...
      <div class="" v-show="step === 4">
        <assets
          :userProfileId="state.userId"
          @backTocompensation="step = 3"
          @assetDone="step = 5"
        />
      </div>
