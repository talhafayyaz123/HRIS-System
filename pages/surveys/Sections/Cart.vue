<template>
    ...
    <div @click="$emit('minimizeCart', !minimizeCart)" class="relative">
        <h5
            :style="
                'color: ' +
        ...
        <!-- <i
            :style="`position: absolute; right: 10px; top: ${minimizeCart ? '10' : '5'}px;`"
            :class="`text-gray-500 fas ${minimizeCart ? 'fa-maximize' : 'fa-window-minimize'} cursor-pointer`"
        ></i> -->
    </div>
    <div class="flex flex-col h-full">
        ...
        <div>
            ...
            <div
                ...
                class="rounded-md shadow-xl card mx-2"
            >
                <h5
                    class="text-gray-900 text-md leading-tight font-medium card-title pb-2 pt-2 text-center"
                >
                ...
                >
                    ...
                    >
                        ...
                        <div
                            v-if="config.isExpertMode"
                            class="flex align-center mt-5"
                        >
                            <button
                                @click="addRoute(index)"
                                type="button"
                                class="bg-red-500 px-2 py-2 rounded text-white mt-3 w-full"
                            >
                                Add Route
                            </button>
                        </div>
                ...
                <button
                    @click="addconfig"
                    type="button"
                    class="docsHeroLayoutColor mt-3 inline-flex w-full justify-center rounded-md border border-transparent bg-gray-500 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-0 sm:w-full sm:text-sm"
                >
                    {{ $t("Add Button") }}
                </button>
            </div>
