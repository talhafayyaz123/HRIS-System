<template>
    ...
    >
        <Sections
            ...
            "
        />
        <div v-if="layout.contains" class="row">
            <div
                v-if="layout.contains === 'steps'"
                :style="`color: ${stylesConfiguration.steps?.cardTextColor}; background-color: ${stylesConfiguration.steps?.cardBgColor}; min-height: 100%`"
            ...
            <div
                ...
                :style="`color: ${stylesConfiguration.questionDetails?.cardTextColor}; background-color: ${stylesConfiguration.questionDetails?.cardBgColor}; min-height: 100%`"
                class="rounded-md shadow-xl card ml-2"
            >
                <Question
                    @selectedInputs="$emit('selectedInputs', $event)"
                    :manualProducts="manualProducts"
            ...
            <div
                ...
                class="rounded-md shadow-xl card"
                :style="`min-height: 500px; color: ${stylesConfiguration.productDetails?.cardTextColor}; background-color: ${stylesConfiguration.productDetails?.cardBgColor}; min-height: 100%`"
            >
                <Details
                    :selectedQuestionParent="selectedQuestion"
                    :stylesConfigurationParent="stylesConfiguration"
            ...
            <div
                ...
                :style="`color: ${stylesConfiguration.cart?.cardTextColor}; background-color: ${stylesConfiguration.cart?.cardBgColor}; min-height: 100%`"
                class="rounded-md shadow-xl card ml-4"
            >
                <Cart
                    @minimizeCart="$emit('minimizeCart', $event)"
                    :minimizeCart="minimizeCart"
