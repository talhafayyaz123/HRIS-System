    ...
    <div>
      ...
      <div v-if="selectedQuestion" :class="`px-3 pb-3 question-details`">
        <div>
          ...
          <div class="form-group textarea" v-else>
            <textarea
                name=""
                id=""
                class="form-control"
...
<!--            </div>-->
    ...
    <div v-if="selectedQuestion" class="flex justify-center py-3">
      ...
      <button
          @click="next"
          type="button"
          class="docsHeroColorBlue inline-flex w-full justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
      >
        {{ $t("Next") }}
      </button>
    </div>
