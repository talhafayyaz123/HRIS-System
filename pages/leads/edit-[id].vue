...
import { listEmployeesRequest, leadShowRequest } from "~/utils/apiRequests";
  ...
  <div>
    ...
    <div class="wizard-tab">
      <ul class="">
        <li class="nav-item" role="presentation">
          <button class="nav-link step-done" @click="step = 1">{{ $t('Lead') }}</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link step-done" @click="step = 2">
            {{ $t('Locations') }}
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link step-done" @click="getEmployees()">
            {{ $t('Employees') }}
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link step-done" @click="step = 4">
            {{ $t('Contact Reports') }}
          </button>
        </li>
      </ul>
    ...
    <div class="wizard-content">
      ...
      <div class="" v-show="step === 4">
        <leads-contact-report
          @leadsDone="leadsDone"
          @backToEmployees="step = 3"
          :leadId="leadId"
        />
      </div>
    </div>
