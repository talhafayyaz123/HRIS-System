...
const update = () => {
  if (companyType.value == "task") {
    vTask$.value.$touch();
    if (vTask$.value.$invalid) {
      submitted.value = false;
      return false;
    }
  } else if (companyType.value == "newEntry") {
    v$.value.$touch();
    if (v$.value.$invalid) {
      submitted.value = false;
      return false;
    }
  } else if (companyType.value == "ticket") {
    vTicket$.value.$touch();
    if (vTicket$.value.$invalid) {
      submitted.value = false;
      return false;
    }
  } else if (companyType.value == "ams") {
    vAms$.value.$touch();
    if (vAms$.value.$invalid) {
      submitted.value = false;
      return false;
    }
  }else if (companyType.value == "travel-expense") {
...
const updateTtimeTrackerRecord = () => {
    ...
    var record;
    if (companyType.value === "newEntry") {
      record = company;
    } else if (companyType.value === "ams") {
      record = amsData;
    } else if (companyType.value === "task") {
      record = taskData;
    }else if (companyType.value==='ticket'){
      record = ticketData;
    }else if (companyType.value==='travel-expense'){
...
watch(
  ...
  () => {
    ...
    const {type,isGoodwill,internalNote,companyId,time,description,uuid,additionalInfo,moduleId}=props.companyRecord;
    if(type==='Travel Expense'){
      companyType.value='travel-expense';
    }

    if(type==='New Entry'){
      companyType.value='newEntry';
    }

    if(type==='Ams'){
      companyType.value='ams';
    }

    if(type==='ticket'){
      companyType.value='ticket';
    }

    if(type==='Task'){
      companyType.value='task';
    }
...
<template>
  ...
  >
    ...
    <!--==================TASK==================-->
    <div class="row" v-if="companyType == 'task'">
    ...
    <!--=================TICKET===================-->
    <div class="row" v-if="companyType == 'ticket'">
      <div class="col-lg-6">
        <div class="form-group">
          <elements-input
    ...
    <!--==================AWS==================-->
    <div class="row" v-if="companyType == 'ams'">
      <div class="col-lg-6">
        <div class="form-group">
          <elements-multiselect
    ...
    <!--==================NEW ENTRY==================-->
    <div class="row" v-if="companyType == 'newEntry'">
      <div class="col-lg-6">
        <div class="form-group">
          <elements-multiselect
    ...
    <!--====================================-->
     <!--==================Travel Agency==================-->
 <div class="row" v-if="companyType == 'travel-expense'">
...
<!--====================================-->
    ...
    <div class="col-lg-12" v-if="companyType">
      <div class="form-group textarea">
        <textarea
          placeholder="."
          v-model="note"
    ...
    <div class="col-lg-6" v-if="companyType">
      <div class="form-group">
    ...
    <div class="d-flex align-items-center justify-content-end mt-3">
      ...
      <submittal-button @click="update()" v-if="companyType" :buttonName="$t('Update')" />
    </div>
  </Modal>
</template>
