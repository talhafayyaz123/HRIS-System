              ...
              <tr v-for="(product, index) in productData" :key="index">
                <td>
                  <div class="checkbox-group">
                    <input type="checkbox" name="license" class="checkbox-input" id="checkbox"
                      @change="addProduct($event, product, product?.id)" />
                    <label class="checkbox-label" for="checkbox"><span>{{ product?.articleNumber }}</span></label>
                  </div>
                </td>
                <td>{{ product?.name }}</td>
                ...
                <td>
                  <div style="width: 100px">
                    <input :value="product?.quantity" @change="changeQuantity($event, product.id)" type="number"
                      class="form-control" />
                  </div>
                </td>
